...
vim.keymap.set("v", "<S-Up>", ":m '>+1<CR>gv=gv", {desc = "Move selection up"})
vim.keymap.set("n", "<S-Down>", ":m .-2<CR>==", {desc = "Move line down"})
vim.keymap.set("v", "<S-Down>", ":m '<-2<CR>gv=gv", {desc = "Move selection down"})
